...
SELECT AVG(NOTA) FROM CALIFICACIONES WHERE PROFESOR_DNI IN (
...
SELECT CU.NOMBRE, ES.NOMBRE FROM ESTUDIANTES ES
JOIN CALIFICACIONES CA
ON ES.DNI = CA.ESTUDIANTE_DNI
JOIN CURSOS CU
ON CA.CURSO_NOMBRE = CU.NOMBRE
